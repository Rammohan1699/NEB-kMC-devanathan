...
def main() -> None:
    ...
    ap.add_argument("--anchor-final-to-initial", action="store_true", default=True, help="Keep final H in same minimum-image periodic image as initial representative candidate")
    ap.add_argument("--no-anchor-final-to-initial", dest="anchor_final_to_initial", action="store_false", help="Disable anchoring final H to initial candidate image")
